-- ==========================================
-- تحديث دالة التنظيف اليومي لتشمل تفعيل الراتب المستقبلي
-- ==========================================
...
BEGIN
  -- 0. تفعيل الراتب المستقبلي للموظفين الذين حان موعد تفعيل رواتبهم
  UPDATE employees 
  SET 
...
COMMENT ON FUNCTION perform_daily_cleanup IS 'تقوم بتنظيف المواقع القديمة، معالجة الحذف المجدول وإرجاع الملفات منتهية الصلاحية من سلة المحذوفات بالإضافة لتفعيل الراتب المستقبلي';
